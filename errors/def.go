...
const (
	...
	ErrRestMissingParam               Error = "the '{param}' parameter is required in the URL path."
	...
	ErrGetResource                             Error = "error while fetching resource %s: %v"
	ErrListResources                           Error = "error while listing resources: %v"
	ErrUpdateResource                          Error = "error while updating resource %s: %v"
	ErrDeleteResource                          Error = "error while deleting resource %s: %v"
	ErrUpdateResourceWithHistory               Error = "error while updating resource with history."
	ErrUpdateResourceSync                      Error = "error while updating resource sync settings."
	ErrFilterResources                         Error = "error while filtering resource: %v"
	ErrCheckResourceExistence                  Error = "error while checking resource existence"
	ErrResourceExists                          Error = "resource already exists"
	ErrResourceNotFound                        Error = "resource not found"
	ErrPatchResource                           Error = "error while patching resource %s status: %s"
	ErrConvertResource                         Error = "error while converting resource to %s: %v"
	ErrResourceHasNoFields                     Error = "%s has no %s"
	ErrRemoveFieldsFromResource                Error = "error while removing %s from %s"
	ErrGenerateManagedResource                 Error = "error while generating managed resource %s: %v"
	ErrUnsupportedResourceType                 Error = "unsupported resource type %s: %v"
	ErrAddResourceToGrouper                    Error = "error while adding resource %s to grouper %s: %v"
	...
	ErrRemoveFromAttachedResources             Error = "failed to remove %s from attached resource: %v"
	...
	ErrCreateValidatingAdmission Error = "error while creating admission validating webhook."
	ErrCreateMutatingAdmission   Error = "error while creating admission mutating webhook."
	ErrGetValidatingAdmission    Error = "error while fetching admission validating webhook."
	ErrGetMutatingAdmission      Error = "error while fetching admission mutating webhook."
	ErrUpdateValidatingAdmission Error = "error while updating admission validating webhook."
	ErrUpdateMutatingAdmission   Error = "error while updating admission mutating webhook."
	ErrDeleteValidatingAdmission Error = "error while deleting admission validating webhook."
	ErrDeleteMutatingAdmission   Error = "error while deleting admission mutating webhook."
	ErrFilterAdmission           Error = "error while filtering admission webhook."
	ErrCheckAdmissionExistence   Error = "error while checking admission webhook existence."
	...
	// NATS-related Errors
	ErrNatsAuth                               Error = "user and password must be set for authentication."
	...
	ErrNatsConnectionFailed                   Error = "nats connection failed. retrying in %s...: %v"
	ErrNatsClientNotAvailable                 Error = "nats client not available"
	ErrNatsInvalidUrl                         Error = "invalid nats server url"
	ErrNatsTopicNotFound                      Error = "topic '{topic}' was not found."
	ErrNatsTopicPublish                       Error = "failed to publish to %s: %v"
	ErrNatsTopicSubscribe                     Error = "failed to subscribe to %s: %v"
	ErrNatsSubscriberManager                  Error = "failed to start subscriber manager: %v"
	ErrNatsClientClosed                       Error = "nats client closed"
	ErrNatsAckMsg                             Error = "failed to acknowledge message: %v"
	...
	ErrNatsNoResourceNameFoundInDeleteMessage Error = "no resource name found in delete message"
